...
class StartCommand : public CommandHandler {
  ...
  public:
    StartCommand() : CommandHandler("start", std::nullopt, "PLID max_playtime",
                                    "Start a new game") {}
};
...
class TryCommand : public CommandHandler {
  ...
  public:
    TryCommand(): CommandHandler("try", std::nullopt, "C1 C2 C3 C4", 
...
class ScoreboardCommand : public CommandHandler {
  ...
  public:
    ScoreboardCommand() : CommandHandler("scoreboard", "sb", std::nullopt, 
